...
<head>
    ...
    <title>Contact - MediMax.com</title> <style>
...
<body> 
    <header class="header">
        ...
        <div class="search-bar ">
            <form method="post" action="contact.php"> <input type="search" name="search_input" placeholder="Search MediMax.com" id="search-input"> <button type="submit" name="search" class="search-icon"><i class="fa-solid fa-magnifying-glass"></i></button>
            </form>
        </div>
    ...
    <div class="container container-contact">
        ...
        <div class="main-content">
            ...
            <form action="submit_feedback.php" method="post" id="contactForm">
                ...
                <textarea id="ufeedback" name="feedback" rows="5" required></textarea> <input type="submit" value="Submit Feedback">
            </form>
            <script src="../JS/Contact_Validation.js"></script> <div class="contact-info">
                <h3>Contact Us Directly On :</h3>
                <p>Email: <a href="mailto:support@medimax.com">support@medimax.com</a></p> <p>Phone: +91 1234567890</p>
