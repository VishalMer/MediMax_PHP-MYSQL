...
<head>
    ...
    <title>Orders - MediMax.com</title> 
</head>
<body>
    <header class="header">
    ...
    <section class="main">
        <?php
        // --- ADDED THIS SECTION FOR MESSAGE DISPLAY ---
                ...
                if($total_products > 0) {
                    ...
                    while ($order = mysqli_fetch_assoc($orders_query)) {
                        ...
                        <tr>
                            ...
                            <td><img src="../Images/<?php echo htmlspecialchars($order['image']); ?>" alt="<?php echo htmlspecialchars($order['name']); ?>" style="width: 50px; height: 50px;"></td> 
